			...
			.addGroup(groupLayout.createSequentialGroup()
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
					.addGroup(groupLayout.createSequentialGroup()
						...
						.addGap(86)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
							.addComponent(playerFourTextField, GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
							.addComponent(playerThreeTextField, 180, 180, 180)
							.addComponent(playerOneTextField, GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
							.addComponent(playerTwoTextField, GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)))
