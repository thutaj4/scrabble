...
public class BeginnerTile extends JPanel implements MouseListener, Cloneable {
  ...
  public BeginnerTile(Point _point, String _text, Color _color, Color _borderColor) {
    point = _point;
    color = _color;
    text = _text;
